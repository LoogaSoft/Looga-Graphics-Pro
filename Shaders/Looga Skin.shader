    ...
    SubShader
    {
            ...
            FragmentOutput Frag(Varyings input, bool isFrontFace : SV_IsFrontFace)
            {
                ...
                half metallic = 0.0; half occlusion = 1.0; half baseSmoothness = 0.5; half3 specularF0 = kDielectricSpec.rgb;
                    ...
                    baseSmoothness = (_SmoothnessTextureChannel == 1.0) ? (albedo.a * _BaseSmoothnessScale) : (specGlossSample.a * _BaseSmoothnessScale);
                        ...
                        metallic = metallicSample.r * _Metallic; half4 occlusionSample = SAMPLE_TEXTURE2D(_OcclusionMap, sampler_BaseMap, input.uv);
                ...
                loogaFlags |= LOOGA_MATERIAL_FLAG_DUAL_LOBE;
        ...
        Pass
        {
            ...
            half4 FragForward(VaryingsForward input, bool isFrontFace : SV_IsFrontFace) : SV_Target
            {
                ...
                color += EvaluateSecondaryGGXLobe(directF0, secondaryRoughness, normalWS, mainLight.direction, viewDirWS, NoV, mainRadiance, finalLobeMix);
                ...
                color += EvaluateLoogaAdditionalLights(diffuseColor, directF0, perceptualRoughness, normalWS, 1.0, viewDirWS, NoV, modelParameters, input.positionWS, screenUV, shadowMask, false, true, secondaryRoughness, finalLobeMix);
        ...
        Pass
        {
            ...
            MaterialExtrasOutput FragMaterialExtras(VaryingsMaterialExtras input)
            {
                ...
                MaterialExtrasOutput output;
                output.materialExtras = half4(secondaryRoughness, lobeMix, 0.0, 1.0);
