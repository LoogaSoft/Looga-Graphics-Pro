...
namespace LoogaSoft.Lighting.Editor
{
    ...
    internal sealed class LoogaLightingFeatureEditor : LoogaEditorBase
    {
        ...
        private bool TryGetRendererMode(out int renderingMode)
        {
            renderingMode = -1;
            ...
            foreach (Object asset in assets)
            {
                ...
                if (!RendererContainsFeature(rendererData))
                    continue;
        ...
        private static string GetRenderingModeName(int renderingMode)
        {
