...
namespace LoogaSoft.Shadows.Editor
{
    internal static class LoogaShadowValidationSceneBuilder
    {
        ...
        [MenuItem("LoogaSoft/Graphics Pro/Shadows/Create Validation Scene", priority = 24)]
        ...
        [MenuItem("LoogaSoft/Graphics Pro/Shadows/Expand Validation Ground Coverage", priority = 24)]
